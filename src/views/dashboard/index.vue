                ...
                <div class="flex-y-center">
                  ...
                  <span
                    :class="[
                      'text-xs',
                      'ml-2',
                      getGrowthRateClass(visitStatsData.uvGrowthRate),
                    ]"
                  >
                    <el-icon>
                ...
                <div class="flex-y-center">
                  ...
                  <span
                    :class="[
                      'text-xs',
                      'ml-2',
                      getGrowthRateClass(visitStatsData.pvGrowthRate),
                    ]"
                  >
                    <el-icon>
          ...
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link type="primary">
                <span class="text-xs" @click="handleViewMoreNotice"
                  >查看更多</span
                >
...
import LogAPI, { type VisitStatsVO } from '@/api/system/log';
import NoticeAPI, { type NoticePageVO } from '@/api/system/notice';
